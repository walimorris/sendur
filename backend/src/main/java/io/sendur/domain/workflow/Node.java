...
public class Node {
    ...
    private boolean alwaysOutputData;
    ...
    public boolean isExecuteOnce() { return executeOnce; }

    @JsonProperty("executeOnce")
    public void setExecuteOnce(boolean executeOnce) { this.executeOnce = executeOnce; }

    @JsonProperty("alwaysOutputData")
    public boolean isAlwaysOutputData() { return alwaysOutputData; }

    @JsonProperty("alwaysOutputData")
    public void setAlwaysOutputData(boolean alwaysOutputData) { this.alwaysOutputData = alwaysOutputData; }
}
