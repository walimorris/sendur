...
public class LeadService {
    ...
    public Lead getLeadByBusinessName(String businessName) {
        return leadRepository.findLeadByBusinessName(businessName);
    }

    public List<Lead> getLeadsByCity(String city) {
        return leadRepository.findLeadsByCity(city);
    }
